...
include_once 'products-data.php'; ?>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-5">
                    ...
                    <p class="help-block">Size more than 1000px</p>
                  </div>
                  <div class="col-md-3">
  ...
  <div class="col-md-10">
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td class="text-center"><a href="products-data.php?delete=<?php echo $product->pd_id ?>">
			<span class="glyphicon glyphicon-trash" onclick="return confirm('Are you sure you want to delete this item from products? If there is an order including this product, order will also be deleted');"> </span></a></td>
          </tr>
        <?php
          }
        ?>
    ...
    <?php
      ...
      <div class="alert alert-warning"> Didn't find any products, please add some.</div>
    <?php
    }
    ?>
  </div>