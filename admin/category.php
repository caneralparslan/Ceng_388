...
include_once 'category-data.php'; ?>
  ...
  <div class="col-md-10">
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td class="text-center"><a href="category-data.php?delete=<?php echo $category->cat_id ?>">
			<span class="glyphicon glyphicon-trash" onclick="return confirm('Are you sure you want to delete this category? If there is an order from this category, order will also be deleted');"> </span></a></td>
          </tr>
        <?php
          }
        ?>
    ...
    <?php
      ...
      <div class="alert alert-warning"> Didn't find any categories, please add some.</div>
    <?php
    }
    ?>
  </div><!-- /col-md-10 -->