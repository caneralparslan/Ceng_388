            ...
            <div class="thumbnail">
              ...
              <div class="caption">
                ...
                <!-- <p><?php echo $product->pd_description ?  $product->pd_description : '<span class="text-muted">No description</span>'; ?></p>
                 --><p><a href="product.php?id=<?php echo $product->pd_id; ?>" class="btn btn-default">View</a> 
				 <?php
					if(isset($user)){
						if(strcmp($user['user_name'], 'admin') != 0){ ?>
							<a href="cart.php?add=<?php echo $product->pd_id; ?>" class="btn btn-primary">Add to cart</a></p>
							<?php 
						}
					}
				?>
